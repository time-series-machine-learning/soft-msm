...
def calculate_percentages(data, soft_method='soft', baseline1='petitjean',
                          baseline2='subgradient'):
...
def generate_latex_from_dataframe(df: pd.DataFrame, method: str) -> str:
    ...
    if method.lower() == 'dtw':
        caption = ("Percentage of datasets on which the Soft-DTW Barycentre Average "
        ...
        caption = ("Percentage of datasets on which the Soft-MSM Barycentre Average "
